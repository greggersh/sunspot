shared_examples_for 'fulltext query' do
  ...
  describe 'with multiple keyword components' do
    ...
    it 'puts default dismax parameters in subquery' do
      subqueries(:q).last[:qf].split(' ').sort.should == %w(backwards_title_text body_textsv spanish_title_text_es tags_textv title_text)
    end
  ...
  it 'searches all text fields for searched class' do
    ...
    connection.searches.last[:qf].split(' ').sort.should == %w(backwards_title_text body_textsv spanish_title_text_es tags_textv title_text)
  end
  ...
  it 'searches both stored and unstored text fields' do
    ...
    connection.searches.last[:qf].split(' ').sort.should == %w(author_name_text backwards_title_text body_text body_textsv spanish_title_text_es tags_textv title_text)
  end
  ...
  it 'excludes text fields when instructed' do
    ...
    connection.searches.last[:qf].split(' ').sort.should == %w(body_textsv spanish_title_text_es tags_textv title_text)
  end
  ...
  it 'sets boost for certain fields without restricting fields' do
    ...
    connection.searches.last[:qf].split(' ').sort.should == %w(backwards_title_text body_textsv spanish_title_text_es tags_textv title_text^1.5)
  end
